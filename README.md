# SmartProbe
Camera based remote crop monitoring using and ESP32 camera.  The solution will provide images of a 1m<sup>2</sup> quadrat with image capture based on a timelapse.  The images will be sent to an Azure server where image processing will be carried out using OpenCV (probably).
